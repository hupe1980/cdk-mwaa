...
export class Environment extends Construct {
  ...
  constructor(scope: Construct, id: string, props: EnvironmentProps) {
    ...
    const environment = new mwaa.CfnEnvironment(this, 'MWAAEnvironment', {
      ...
      pluginsS3Path: props.dagStorage.pluginsConfig?.s3Path,
      pluginsS3ObjectVersion: props.dagStorage.pluginsConfig?.s3ObjectVersion,
      requirementsS3Path: props.dagStorage.requirementsConfig?.s3Path,
      requirementsS3ObjectVersion: props.dagStorage.requirementsConfig?.s3ObjectVersion,
      startupScriptS3Path: props.dagStorage.startupScriptConfig?.s3Path,
      startupScriptS3ObjectVersion: props.dagStorage.startupScriptConfig?.s3ObjectVersion,
